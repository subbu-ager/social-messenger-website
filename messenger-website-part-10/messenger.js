    ...
    // insert chat messages
     ...
     $(document).on('keyup','#chat-type',function(){
        ...
        if(chatType.length > 0){
          ...
          $('.messenger-chat-bottom-send-inside').hide();
         
          $('.messenger-chat-bottom-send-message').show();
         
            
        }else{
            
            $('.messenger-chat-bottom-send-inside').show();
         
            $('.messenger-chat-bottom-send-message').hide();
     ...
     $(document).on('click','.messenger-chat-bottom-send-message',function(){
         
         var recieverId = $(this).attr('id');
         
         var chatMessage = $('#chat-type').val();
       
         var type = "text";
         
         insert_chat_message(recieverId, type, chatMessage);     
        
    });
    
    
    function insert_chat_message(recieverId, type, chatMessage){
           
       var action = 'insert_chat_message';
        ...
        $.ajax({
             ...
             data:{insert_chat_message:action, reciever_id:recieverId, type:type, 
