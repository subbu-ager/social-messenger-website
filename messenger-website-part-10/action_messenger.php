             ...
             <div class="messenger-message-left">
                ...
                <div class="messenger-chat-bottom">
                   ...
                   <div class="messenger-chat-bottom-input">
                      ...
                      <div class="messenger-chat-bottom-input-inside">
                         ...
                         <div class="messenger-chat-input-type">
                            ...
                            <input type="text" placeholder="Type a message..." id="chat-type">
                   ...
                   <div class="messenger-chat-bottom-send">
                     ...
                     <div class="messenger-chat-bottom-send-message" id="'.$search_userId.'">
...
// insert chat messages
 ...
 if(isset($_POST['insert_chat_message'])){
     ...
     $sql = "INSERT INTO `user_chat_message`(`sender_id`, `reciever_id`, `chat_message`,       
     
            `type`) VALUES ('$senderId','$recieverId','$chatMessage','$type')";
     
     $result = mysqli_query($conn, $sql);
     
     if($result){
         
        $sqls ="SELECT * FROM `chat_users` WHERE `sender_id` = '$senderId' AND `reciever_id` = 
         
               '$recieverId'";
         
         $sql_result = mysqli_query($conn, $sqls);
         ...
         if(mysqli_num_rows($sql_result)>0){
             ...
             $query = "INSERT INTO `chat_users`(`sender_id`, `reciever_id`) VALUES 
             ...
             if($query_result){
                 ...
                 echo "insert chat message success";
             }
         }
